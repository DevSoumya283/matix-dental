...
class ElasticSearch
{
    ...
    private function call($path, $method = 'POST', $data = null)
    {
        if (!$this -> index) {
    ...
    public function query_wresultSize($type, $query, $size = 2000)
    {
     ...
     * @return type
     */
    public function query_all_wresultSize($query, $from = 0, $size = 10)
    {
