...
class Stripe
{
    ...
    /**
     * [createToken Creates a token than can then be used for subsequent operations]
     *
     * @param array|null $params
     * @param array|string|null $options
     *
     * @return \Stripe\Token The created token.
     */
     ...
     * @param array|string|null $options
     *
     * @return \Stripe\Charge The created charge.
     */
    public function addCharge($params = [], $options = null)
    {
    ...
    /**
     * [addAccount Creates a new managed account object.]
     *
     *
     * @return  [A account object if the call succeeded]
     */
    public function addAccount($options=[])
    {
        return \Stripe\Account::create($options);
    }

    /**
     * [getAccount Retrieves the details of an existing account. You need only supply the unique account
     *              identifier that was returned upon account creation.]
     *
     * @param   $account_id [ID stripe of account]
     *
    ...
    /**
     * [listAccounts Retrieves a list of connected accounts.]
     *
     *
