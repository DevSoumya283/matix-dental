        ...
        <div class="wrapper wrapper--fixed">
            <ul class="list list--inline list--breadcrumbs">
                ...
                <li class="item is--active">
                    Recurring <?php echo $recurring_order->id; ?>
                </li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="invoice">
                        <div class="inv__head row">
                            <div class="col col--2-of-8 col--am">
                                ...
                                <?php } else { ?>
                                    <img class="inv__logo" src="" alt="" style="background-image:url('http://placehold.it/192x192');">
                                <?php } ?>
                            </div>
                            <div class="col col--4-of-8 col--push-2-of-8 col--am align--right">
                                <span class="fontWeight--2 fontSize--m textColor--dark-gray">Recurring <?php echo $recurring_order->id; ?></span>
                                <input type="hidden" name="" class="recurring_id" value="<?php echo $recurring_order->id; ?>">
                                <div class="select select--text">
                                    <select aria-label="Select a Sorting Option" class="change-frequency">
                                        <option <?php
                                        if ($recurring_order->frequency == 'Daily') {
                                            echo 'selected';
                                        }
                                        ?> value="Daily">Daily</option>
                                        <option <?php
                                        if ($recurring_order->frequency == 'Weekly') {
                                            echo 'selected';
                                        }
                                        ?> value="Weekly">Weekly</option>
                                        <option <?php
                                        if ($recurring_order->frequency == 'Bi-weekly') {
                                            echo 'selected';
                                        }
                                        ?> value="Bi-weekly">Bi-Weekly</option>
                                        <option <?php
                                        if ($recurring_order->frequency == 'Monthly') {
                                            echo 'selected';
                                        }
                                        ?>  value="Monthly">Monthly</option>
                                        <option <?php
                                        if ($recurring_order->frequency == 'Quarterly') {
                                            echo 'selected';
                                        }
                                        ?> value="Quarterly">Quarterly</option>
                                        <option <?php
                                        if ($recurring_order->frequency == 'Yearly') {
                                            echo 'selected';
                                        }
...
//                                    else if ($inn >= 51 && $inn <= 55) {
                            ...
                            ?>
                            <a class="link fontWeight--2 fontSize--s modal--toggle" data-target="#changePaymentModal">Change</a>
                        </div>
                            ...
                            <tbody>
                                ...
                                for ($i = 0; $i < count($order_details); $i++) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="input input--qty not--empty update_recurqty" min="1" value="<?php echo $order_details[$i]->quantity; ?>" type="number">
                        ...
                        <div class="inv__totals">
                            <div class="wrapper">
                                <div class="wrapper__inner">
                                    ...
                                    ?><br>
                                    <a class="link fontWeight--2 fontSize--s modal--toggle change-recurring-location" data-id="<?php echo $recurring_order->id; ?>" data-location_name="<?php echo $shipping_address->nickname; ?>" data-target="#changeShippingAddressModal">Change</a>
                                </div>
                                <div class="wrapper__inner align--right">
                                    ...
                                    <span class="fontWeight--2">Next Order Total: $<?php echo number_format($total, 2, '.', ','); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="sidebar col col--2-of-12">
                    <div class="sidebar__group margin--m">
                        <ul class="list">
                            <li class="item">
                                <button class="btn btn--s btn--secondary modal--toggle delete_recurring" data-id="<?php echo $recurring_order->id; ?>" data-target="#cancelRecurringModal">Cancel Order</button>
                            </li>
                        </ul>
                    </div>
                </div>
...
<?php include(INCLUDE_PATH . '/_inc/shared/modals/change-shipping-address.php'); ?>
