<div id="reportTax" class="page__tab">
    <!-- Heading -->
    <div class="heading__group border--dashed padding--s no--pad-lr no--pad-t wrapper">
        <div class="wrapper__inner">
            <h4>Taxable Purchases</h4>
        </div>
        <div id="controlsTaxReport" class="contextual__controls wrapper__inner align--right">
            <ul class="list list--inline fontWeight--2 fontSize--s disp--ib">
                <li class="item">
                    <a class="link print_tax_report" href="javascript:void(0)">Print</a>
                </li>
            </ul>
            <button class="btn btn--tertiary btn--s  margin--s no--margin-tb no--margin-r"  id="exportscsv3" data-export="export">Download</button>

            <button class="btn btn--primary btn--s  margin--xs no--margin-tb no--margin-r" id="productsComparisonButton2" data-target="#productsComparisonModal2">Compare</button>
        </div>
    </div>
    <!-- /Heading -->
    <!-- Purchased Products Modal -->
    <div id="productsComparisonModal2" class="modal modal--l">
        <div class="modal__wrapper modal__wrapper--transition">
            <a href="javascript:void(0);" class="modal__close modal--toggle icon icon--x"><svg class="icon icon--x"><use xlink:href="#icon-x"></use></svg></a>
            <div class="modal__header center center--h align--left mobile-center" style="max-width:640px;">
            ...
            <div class="modal__body center center--h align--left cf" style="max-width:640px;">
                <div class="modal__content modal-margin">
                    <canvas id="chartProductsComparison2" class="chart"></canvas>
                </div>
            </div>
        </div>
         ...
         <div class="col-md-6 col-xs-12">
            <div class="input__group input__group--date-range is--inline input-daterange">
                ...
                <div class="range__fields">
                    <input type="text" class="input input--date starttaxdate" placeholder="MM/DD/YYYY" name="start" disabled>
                    <input type="text" class="input input--date endtaxdate" placeholder="MM/DD/YYYY" name="end" disabled>
                </div>
            </div>
        </div>
        <div class="col col--5-of-8 col--am align--right">
            <ul class="list list--inline list--filters disp--ib">
                <li class="item item--filter tax_location" id="tax_location" style="display: none;">
                    Location Name
                    <a class="filter--clear" href="#"></a>
                </li>
                <li class="item item--filter tax_vendor" id="tax_vendor" style="display: none;">
                    Vendor Name
                    <a class="filter--clear" href="#"></a>
                </li>
                <li class="item item--filter tax_category" id="tax_category" style="display: none;">
                    Category Name
                    <a class="filter--clear" href="#"></a>
                </li>
            </ul>
            <button class="btn btn--tertiary btn--s btn--icon margin--s no--margin-tb no--margin-r modal--toggle" data-target="#configReportModal3"><svg class="icon icon--settings"><use xlink:href="#icon-settings"></use></svg></button>
        </div>
    </div>
    <!-- /Filters -->
    <div id="configReportModal3" class="modal modal--m">
        <div class="modal__wrapper modal__wrapper--transition padding--l">
            <a href="javascript:void(0);" class="modal__close modal_close3 modal--toggle icon icon--x"><svg class="icon icon--x"><use xlink:href="#icon-x"></use></svg></a>
            ...
            <div class="modal__body center center--h align--left cf">
                <div class="form__group">
                    <div class="modal__content modal-margin">
                        <div class="row form__row" style="margin-bottom:24px;">
                            <div class="col col--6-of-6 col--am">
                                <div class="input__group input__group--date-range is--inline input-daterange">
                                    ...
                                    <div class="range__fields">
                                        <input type="text" class="input input--date cstartDate3" placeholder="MM/DD/YYYY" name="start_date" name="rangeFrom">
                                        <input type="text" class="input input--date cendDate3" placeholder="MM/DD/YYYY" name="end_date" name="rangeFrom">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="input__group is--inline">
                                <div class="select">
                                    <select name="categories" class="all_categories3 tax_categories" required>
                        ...
                        <div class="row">
                            <div class="input__group is--inline">
                                <div class="select">
                                    <select name="locName" class="locations3 tax_locations" required>
                        ...
                        <div class="row">
                            <div class="input__group is--inline">
                                <div class="select">
                                    <select name="vendorName" class="vendors3 tax_vendors" required>
                    ...
                    <div class="footer__group border--dashed modal-margin">
                        <button class="btn btn--m btn--primary btn--block save--toggle configure-tax">Apply</button>
                    </div>
                </div>
                <!--</form>-->
            </div>
    ...
    <!-- Report -->
    <div class="report tax_report">
     <?php $this->load->view('templates/account/reports/tax_data.php'); ?>
        <!-- /Report -->
    </div>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.3.0/Chart.min.js"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            $('#productsComparisonButton2').hide();
            $(document).on("change", '.single-checkbox2', function (e) {
                if ($('.single-checkbox2:checked').length == 2) {
                    $('#productsComparisonButton2').show();
                } else {
                    $('#productsComparisonButton2').hide();
                }
            });
            $(document).on("click", "#productsComparisonButton2", function () {
                ...
                var product1 = $('.single-checkbox2:checked')[0].value;
                var product2 = $('.single-checkbox2:checked')[1].value;

                $.getJSON(base_url + "compare-tax?product1=" + product1 + "&product2=" + product2, function (data) {
                    console.log(data);
                    // Products Comparison
                    var products = document.getElementById("chartProductsComparison2");
