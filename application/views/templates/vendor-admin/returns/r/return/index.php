    ...
    <div class="bar padding--xs bg--lightest-gray">
        <div class="wrapper wrapper--fixed">
            <ul class="list list--inline list--breadcrumbs">
                <li class="item">
                    <a class="link" href="<?php echo base_url(); ?>vendor-orderReturn-closed">Closed Returns</a>
                </li>
                <li class="item is--active">
                    Return <?php echo $order_returns->id; ?>
                </li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="well card is--neutral">
                        <div class="wrapper">
                            <div class="wrapper__inner">
                                <!--                                <h3 class="no--margin">Refunded/Denied/Closed</h3>-->
                                <h3 class="no--margin"><?php echo $order_returns->return_status; ?></h3>
                            </div>
                            <div class="wrapper__inner align--right">
                                <ul class="list list--inline list--divided disp--ib fontWeight--2 fontSize--s">
                                    <li class="item">
                                        <a class="link print_view_order">Print</a>
                                    </li>
                                    <li class="item">
                                    ...
                                    <?php foreach ($customer_details as $details) { ?>
                                        <div class="wrapper__inner">
                                            <ul class="list list--inline list--divided list--stats">
                                                ...
                                                <li class="item item--stat">
                                                    <div class="text__group">
                                                        <span class="line--main"><?php echo date('M d, Y', strtotime($details->created_at)); ?></span>
                                        ...
                                        <div class="wrapper__inner align--right">
                                            <ul class="list list--inline list--divided list--stats">
                                                <li class="item item--stat align--right">
                                                    <div class="text__group">
                                                        <span class="line--main"><?php echo "$" . $details->total; ?></span>
                        ...
                        <table class="table table--invoice">
                            ...
                            <tbody>
                                ...
                                <?php if ($orderItems != null) { ?>
                                    <?php foreach ($orderItems as $returns) { ?>
                                        <tr>
                                            <td>
                                                <!-- Product -->
                            ...
                            <div class="wrapper">
                                ...
                                <div class="wrapper__inner align--right">
                                    <?php foreach ($calculation_section as $total) { ?>
                                        ...
                                        <span class="fontWeight--2">Refund Amount: <?php echo "$" . $grand_total; ?></span>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
