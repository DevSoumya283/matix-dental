    ...
    <div class="bar padding--xs bg--lightest-gray">
        <div class="wrapper wrapper--fixed">
            <ul class="list list--inline list--breadcrumbs">
                <li class="item">
                    <a class="link" href="<?php echo ROOT_PATH . 'templates/vendor-admin/returns/open'; ?>">Returns</a>
                </li>
                        ...
                        <div class="wrapper">
                            <div class="wrapper__inner">
                                <ul class="list list--inline list--divided disp--ib fontWeight--2 fontSize--s">
                                    <li class="item">
                                        <h3 class="no--margin">Pending Return</h3>
                                    </li>
                                    <li class="item">
                            ...
                            <div class="wrapper__inner align--right">
                                <ul class="list list--inline list--divided">
                                    <li class="item">
                                        <a class="link is--neg fontWeight--2 fontSize--s modal--toggle closeRequestOrder" data-return_id="<?php echo $order_title->id; ?>" data-target="#closeRequestModal">Close Request</a>
                                    </li>
                                    <li class="item">
                                        <button class="btn btn--m btn--primary modal--toggle processRefundOrder" data-return_id="<?php echo $order_title->id; ?>" data-target="#processRefundModal">Process Refund</button>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <?php if ($order_returns != null) { ?>
                                    <?php foreach ($order_returns as $returns) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <input class="input input--qty" value="3" type="number">
                                            </td>
                                        </tr>
                                        <?php
                                    }
                                ...
                                <?php foreach ($order_activity as $activity) { ?>
                                    <li class="item">
                                        <div class="entity__group">
                                            ...
                                            <?php } ?>
                                            <span class="fontWeight--2"><?php echo $activity->user_name; ?></span> marked this order <span class="fontWeight--2"><?php echo $activity->status; ?></span> <span class="fontSize--xs textColor--dark-gray"><?php echo $activity->created_at; ?></span>
                                        </div>
                                    </li>
                                <?php } ?>
                            <?php } else { ?>
...
<!-- Modals -->
<?php include(INCLUDE_PATH . '/_inc/shared/modals/close-request.php'); ?>
<?php include(INCLUDE_PATH . '/_inc/shared/modals/process-refund.php'); ?>
