    ...
    <div class="bar padding--xs bg--lightest-gray">
        <div class="wrapper wrapper--fixed">
            <ul class="list list--inline list--breadcrumbs">
                <li class="item">
                    <a class="link" href="<?php echo ROOT_PATH . 'templates/vendor-admin/orders/returns'; ?>">Returns</a>
                </li>
                <li class="item is--active">
                    Return <?php echo $return_id; ?>
                </li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="order well card is--pos">
                        <div class="heading__group wrapper border--dashed padding--s no--pad-lr no--pad-t">
                            <div class="wrapper__inner">
                                <h4 class="textColor--darkest-gray">Return <?php echo $return_id; ?></h4>
                            </div>
                            <div class="wrapper__inner align--right">
                                <ul class="list list--inline list--divided fontWeight--2 fontSize--s">
                                    ...
                                    <li class="item">
                                        <button class="btn btn--s btn--primary is--link" data-target="<?php echo base_url(); ?>closedReturn-orderReport?return_id=<?php echo $return_id; ?>">View Return</button>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <div class="order__btn col col--2-of-12 col--am align--right">
                                        <ul class="list list--inline list--stats">
                                            <li class="item item--stat">
                                                <div class="text__group">
                                                    <span class="line--main font"><?php echo "$" . $total_count; ?></span>
                                                    <span class="line--sub">Total Refund</span>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
