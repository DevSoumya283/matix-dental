                    ...
                    <div class="row border border--dashed border--1 border--light border--b padding--m no--pad-lr no--pad-t pull--up-xs">
                        <div class="col col--3-of-8 col--am">
                            <div class="input__group input__group--date-range is--inline input-daterange">
                                ...
                                <input type="text" class="input input--date vendorStartDate" id="startDate" value="<?php echo date('m/d/Y', strtotime($start_date)); ?>"  placeholder="MM/DD/YYYY" name="start" disabled>
                                <input type="text" class="input input--date vendorEndDate" id="endDate" value="<?php echo date('m/d/Y', strtotime($end_date)); ?>" placeholder="MM/DD/YYYY" name="end" disabled>
                            </div>
                        </div>
...
<?php $this->load->view('templates/_inc/shared/modals/config-report-vendor-customer.php'); ?>
