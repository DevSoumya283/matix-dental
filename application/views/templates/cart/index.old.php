...
<html>
    ...
    <body class="no--scroll bg--darkest-gray">
        <form id="confirmCheckout" action="<?php echo base_url("cartcheckout"); ?>" class="form__group" method="post">
                    ...
                    <div class="wrapper__inner">
                        <ul class="list list--inline list--divided">
                            ...
                            <li class="item">
                                ...
                                <div class="input__combo has--tip" data-tip="Applied to all applicable orders" data-tip-position="right" style="width: 300px;">
                    ...
                    <div class="wrapper__inner align--right">
                        <ul class="list list--inline list--divided">
                            ...
                            <li class="item first">
                                ...
                                <button class="btn btn--l btn--primary modal--toggle checkout button_new"  onclick="orderFormValidation()" id="orderbutn">
                                    <?php
                                    $matix_count = 0;
                                    $independent_count = 0;
                                    $order_count = 0;
            ...
            <!-- Content Section -->
            <div class="tab__container container--fill padding--xxxl">
                <?php if (isset($matix_vendor) && count($matix_vendor) > 0) { ?>
                    <!-- Order ( from Matix vendor group start) -->
                    <div id="order1" class="page__tab">
                        <div class="tab__nav">
                            MatixDental
                            <button class="btn btn--s btn--icon btn--tertiary btn--link modal--toggle close--tab close--vendor" data-counter="" data-count_items="<?php echo count($matix_vendor); ?>" data-logo="" data-vendor_id="" data-l_id="<?php echo $user_zip->id; ?>" data-target="#removeMatixModal"><svg class="icon icon--x"><use xlink:href="#icon-x"></use></svg></button>
                        </div>
                        <div class="tab__head">
                            <div class="wrapper">
                        ...
                        foreach ($vendors as $vendor_data) {
                            if ($key[$i] == $vendor_data->id) {
                                ...
                                <div class="tab__nav">
                                    ...
                                    <button class="btn btn--s btn--icon btn--tertiary btn--link modal--toggle close--tab close--vendor" data-counter="<?php echo $key[$i]; ?>" data-count_items="<?php echo $product_count ?>" data-logo="<?php echo $vendor_logo ?>" data-vendor_id="<?php echo $vendor_data->id; ?>" data-l_id="<?php echo $user_zip->id; ?>" data-target="#removeOrderModal"><svg class="icon icon--x"><use xlink:href="#icon-x"></use></svg></button>
                                </div>
                                <div class="tab__head">
                                    <div class="wrapper">
                                        <?php
                                            ...
                                            foreach ($image as $images) {
                                                if ($key[$i] == $images->model_id) {
                                                    if ($images != null) {
                                                        ?>
                                                        <div class="wrapper__inner" style="width:168px; padding-right:16px;">
                                                            <img class="inv__logo" src="<?php echo base_url(); ?>uploads/vendor/logo/<?php echo $images->photo; ?>" alt="">
                                                        </div>
                                                        <?php
                                                    }
                                                }
