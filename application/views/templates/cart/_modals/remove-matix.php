<!-- Remove Order Modal -->
<div id="removeMatixModal" class="modal modal--m">
    <div class="modal__wrapper modal__wrapper--transition padding--l">
        <a href="javascript:void(0);" class="modal__close modal--toggle icon icon--x"><svg class="icon icon--x"><use xlink:href="#icon-x"></use></svg></a>
        <div class="modal__header">
            <h2>Remove All Matix Vendor Orders?</h2>
                ...
                <div class="invoice">
                    <div class="inv__head no--pad row">
                        ...
                        <div class="col col--5-of-8 col--am align--right">
                            <span class="fontWeight--2 textColor--dark-gray">Vendors:</span>
                ...
                <div class="footer__group border--dashed">
                    <div class="wrapper">
                        <div class="wrapper__inner">
                            ...
                            <a class="link fontSize--s fontWeight--2 is--neg modal--toggle  remove-matix-vendor">Delete Items</a>
                        </div>
                        <div class="wrapper__inner align--right">
                            <button class="btn btn--m btn--primary modal--toggle matix-save-later">Save for Later</button>
                        </div>
                    </div>
                </div>
            </div>
