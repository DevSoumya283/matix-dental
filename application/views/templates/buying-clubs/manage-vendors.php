                ...
                <div class="content col col--9-of-12 col--push-1-of-12">
                    <div class="heading__group border--dashed">
                        ...
                        <div class="col col--9-of-12">
                            <h3>My Buying Clubs - <?php echo $buyingClub->name; ?> - Vendors</h3>
                        </div>
                    </div>
                    ...
                    <?php foreach($vendors as $vendor){ ?>
                        <tr>
                            <td style="width: 100%"><?php echo $vendor->name; ?></td>
                            <td><a href="/buying-club/delete-vendor?vendor_id=<?php echo $vendor->vendor_id; ?>&buying_club_id=<?php echo $buyingClub->id; ?>" class="btn btn--s btn--primary btn--block">Delete</td>
                        </tr>
                    <?php } ?>
                    </table>
                    </div>
