<!-- Delete User Modal -->
<div id="deletePendingUserModal" class="modal modal--m">
    <form id="DeletePendingUser" action="<?php echo base_url(); ?>delete-pending-user" method="post">
    ...
    <!--                        <div class="avatar avatar--s" style="background-image:url('<?php echo image_url(); ?>assets/img/ph-avatar.jpg');"></div>-->
                            The selected user(s) License will be deleted from the system and cannot be Retrieved.
                        </div>
                    </div>
