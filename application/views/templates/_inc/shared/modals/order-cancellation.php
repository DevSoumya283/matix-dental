...
<div id="orderCancellationModal" class="modal modal--m">
    <div class="modal__wrapper modal__wrapper--transition padding--l">
        <a href="javascript:void(0);" class="modal__close modal--toggle icon icon--x"><svg class="icon icon--x"><use xlink:href="#icon-x"></use></svg></a>
        <div class="modal__header center center--h align--left mobile-center">
            <h2>Cancel this order?</h2>
            <p class="margin--m no--margin-r no--margin-t no--margin-l modal-margin">To cancel this order, you must contact the seller directly.</p>
        </div>
        <div class="modal__body center center--h align--left cf">
            <div class="modal__content">
                <form  id="OrderCancellation" class="form__group modal-margin" action="<?php echo base_url("cancel-order"); ?>" method="post">
                    ...
                    <div class="footer__group border--dashed">
                        <button class="btn btn--m btn--block is--neg default--action form--submit page--reload" data-target="#OrderCancellation">Cancel Order</button>
                    </div>
                </form>
            </div>
        </div>
