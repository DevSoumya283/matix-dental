...
<div id="composeMessageModal" class="modal modal--l">
    <div class="modal__wrapper modal__wrapper--transition padding--l no--pad-r no--pad-l">
        ...
        <div class="modal__body center center--h align--left cf">
            <form id="newMessageForm" class="modal__content">
                    ...
                    <div class="row">
                        ...
                        <div class="col col--5-of-6 col--am">
                            <div class="input__group is--inline">
                                <input id="recipientName" name="recipientName" class="input" type="text" required>
                                <label class="label" for="recipientName">User, Vendor, Email Address</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="input__group is--inline">
                    <textarea name="messageBody" placeholder="Enter your message..." class="input input--l input--show-placeholder" required></textarea>
                </div>
