<!-- Add Note Modal -->
<div id="addNoteModal" class="modal modal--m">
    <div class="modal__wrapper modal__wrapper--transition padding--l">
        ...
        <div class="modal__body center center--h align--left cf">
            <div class="modal__content">
                <form id="addNoteForm" class="form__group" action="<?php echo base_url(); ?>vendors-notes-dashboard" method="post">
                    <div class="row">
                        <div class="input__group is--inline">
                            <?php if (isset($order_id)) { ?>
                                <input type="hidden" name="order_id" value="<?php echo $order_id; ?>">
                            <?php } else { ?>
                                <input type="hidden" class="cancel_order_id" name="order_id" value="" id="order_id">
                            <?php } ?>
                            <!--                    Note : Used by the VENDOR Section-->
