...
<div id="approvePendingUserModal" class="modal modal--m">
    <form id="DeletePendingUser" action="<?php echo base_url(); ?>approve-pending-user" method="post">
        <div class="modal__wrapper modal__wrapper--transition padding--l">
            <a href="javascript:void(0);" class="modal__close modal--toggle icon icon--x"><svg class="icon icon--x"><use xlink:href="#icon-x"></use></svg></a>
            <div class="modal__header center center--h align--left">
                <h2>Aprrove License</h2>
    ...
    <!--                        <div class="avatar avatar--s" style="background-image:url('<?php echo image_url(); ?>assets/img/ph-avatar.jpg');"></div>-->
                            The selected user(s) License will be approved and notification mail will be sent
                        </div>
                    </div>
                    <div class="footer__group border--dashed">
                        <input type="hidden" name="user_id" value="" id="deleteUser_id">
                        <button class="btn btn--m btn--primary  btn--block form--submit">Approve License(s)</button>
                    </div>
                </div>
            </div>
        </div>
