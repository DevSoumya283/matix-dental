<!-- Assign Users Modal -->
<div id="addOrganUsersModal" class="modal modal--m">
    <div class="modal__wrapper modal__wrapper--transition padding--l">
        ...
        <div class="modal__body center center--h align--left cf">
            <form id="newUser" class="modal__content" action="<?php echo base_url(); ?>invite-user" method="post">
                ...
                <div class="footer__group border--dashed">
                    <button class="btn btn--m btn--primary btn--block save--toggle form--submit" data-target="#addOrganUsersModal" type="submit">Add Users</button>
                </div>
            </form>
        </div>
    </div>
