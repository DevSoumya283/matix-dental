<!-- Flag Review Modal -->
<div id="flagAnswerModal" class="modal modal--m">
    <div class="modal__wrapper modal__wrapper--transition padding--l">
        <a href="javascript:void(0);" class="modal__close modal--toggle icon icon--x"><svg class="icon icon--x"><use xlink:href="#icon-x"></use></svg></a>
        <div class="modal__header center center--h align--left">
            <h2>Flag review as inappropriate?</h2>
            <p class="margin--m no--margin-r no--margin-t no--margin-l">Are you sure you want to flag this Answer as inappropriate? If yo do, it will be submitted to an admin to review.</p>
        </div>
        <div class="modal__body center center--h align--left cf">
            <div class="modal__content">
                <form id="askQuestionForm" action="<?php echo base_url("flag-answer"); ?>" class="form__group" method="post">
                    <div class="row align--right">
                        <input type="hidden" name="answer_id" class="answer_id" value="">
                        <input type="hidden" name="question" class="question" value="">
