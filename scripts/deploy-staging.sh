...
echo "Uploading site..."
scp matix_deployment.tar.gz ec2-user@ec2-13-56-83-75.us-west-1.compute.amazonaws.com:/var/www/matix/
rm matix_deployment.tar.gz
echo "Connecting to remote server..."
ssh ec2-user@ec2-13-56-83-75.us-west-1.compute.amazonaws.com << \EndOfCommands
